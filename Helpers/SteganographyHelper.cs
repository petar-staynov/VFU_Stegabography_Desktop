...
namespace VFU_Stegabography_Desktop.Helpers
{
    public class SteganographyHelper
    {
        ...
        public Bitmap EmbedText(string text, Bitmap bmp)
        {
            ...
            for (int hIndex = 0; hIndex < bmp.Height; hIndex++)
            {
                ...
                for (int wIndex = 0; wIndex < bmp.Width; wIndex++)
                {
                    ...
                    Color pixel = bmp.GetPixel(wIndex, hIndex);
                    ...
                    for (int colorIndex = 0; colorIndex < 3; colorIndex++)
                    {
                        ...
                        if (pixelElementIndex % 8 == 0)
                        {
                            ...
                            if (state == State.Filling_With_Zeros && zeros == 8)
                            {
                                ...
                                {
                                    bmp.SetPixel(wIndex, hIndex, Color.FromArgb(R, G, B));
                                }
        ...
        private int ReverseBits(int colorIndex)
        {
            int result = 0;

            for (int hIndex = 0; hIndex < 8; hIndex++)
            {
                result = result * 2 + colorIndex % 2;
